    ...
    return (
        <>
            <main className="demo-page-content">
                <div className="flex h-full overflow-auto w-full justify-center items-center">
                    <div className="w-max max-w-max bg-[#1f1e30] h-max rounded-[24px] shadow-md p-6 overflow-auto">
                        <h2 className="text-3xl font-bold text-gray-200 mb-4 font-font2">Create Supplier</h2>
...
export default SuppliersPageForm
