...
export default function DataTable({ columns, users, statusOptions, section }) {
        ...
        return (
            <div className="flex flex-col gap-4 mt-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small font-font2">Total {users.length} users</span>
                </div>
            </div>
        );
    }, [
    ...
    const classNames = React.useMemo(
        () => ({
            wrapper: ["max-h-[382px]", "max-w-3xl", "overflow-scroll"],
            th: ["bg-transparent", "text-default-500", "border-b", "border-divider", "font-font1 font-[400]"],
            td: [
